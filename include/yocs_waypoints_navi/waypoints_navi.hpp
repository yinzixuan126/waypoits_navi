...
public:
  ...
  void clickedpointCB(const geometry_msgs::PointStamped& clickedpoint);//接受rviz的clicked point
...
private:
  ...
  unsigned int        clicked_point_size;
  ...
  //添加waypoint waypoint list

  yocs_msgs::WaypointList wp_list_clicked;
